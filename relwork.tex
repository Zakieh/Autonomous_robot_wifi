...
\zaki{In these literature, RSSI or CSI is the only sensing method employed for localization/SLAM and most of them require a training phase for creating a map of Wi-Fi data.}
